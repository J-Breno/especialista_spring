...
INSERT INTO tb_order(id, subtotal, shipping_fee, total_value, status, creation_date, confirmation_date, delivery_date, cancellation_date, address_city_id, address_cep, address_street, address_number, address_neighborhood, address_complement, user_id, restaurant_id, payment_method_id)
VALUES
(1, 100.00, 10.00, 110.00, 'CREATING', UTC_TIMESTAMP(), UTC_TIMESTAMP(), UTC_TIMESTAMP(), NULL, 1, '38400-000', 'Rua A', '123', 'Centro', 'Apto 101', 1, 1, 1),
(2, 50.00, 9.50, 59.50, 'CREATING', UTC_TIMESTAMP(), UTC_TIMESTAMP(), UTC_TIMESTAMP(), NULL, 2, '38400-000', 'Rua B', '456', 'Bairro B', NULL, 2, 2, 3);
