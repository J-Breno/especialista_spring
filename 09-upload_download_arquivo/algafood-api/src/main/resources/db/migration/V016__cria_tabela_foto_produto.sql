...
DROP TABLE IF EXISTS tb_restaurant_user;
...
INSERT INTO tb_restaurant_user(restaurant_id, user_id)
VALUES
    (1, 1),
    (1, 2),
    (2, 3),
...
ALTER TABLE tb_order ADD CONSTRAINT ul_order_code UNIQUE (code);

INSERT INTO tb_order(id, code, subtotal, shipping_fee, total_value, status, creation_date, confirmation_date, delivery_date, cancellation_date, address_city_id, address_cep, address_street, address_number, address_neighborhood, address_complement, user_id, restaurant_id, payment_method_id)
VALUES
    (1,'81226e3b-522c-48b3-8749-4b0d9d8e6099', 100.00, 10.00, 110.00, 'CREATING', UTC_TIMESTAMP(), UTC_TIMESTAMP(), UTC_TIMESTAMP(), NULL, 1, '38400-000', 'Rua A', '123', 'Centro', 'Apto 101', 1, 1, 1),
    (2,'9a7a204f-6083-477c-84b9-823032c2cf37', 50.00, 9.50, 59.50, 'CREATING', UTC_TIMESTAMP(), UTC_TIMESTAMP(), UTC_TIMESTAMP(), NULL, 2, '38400-000', 'Rua B', '456', 'Bairro B', NULL, 2, 2, 3);

INSERT INTO tb_order_item(id, quantity, unit_price, total_price, observation, order_id, product_id)
VALUES
    (1, 2, 50.00, 100.00, 'Sem cebola', 1, 1),
    (2, 1, 50.00, 50.00, 'Com borda recheada', 2, 3);
...
CREATE TABLE tb_photo_product (
    ...
    constraint fk_photo_product_product foreign key (product_id) references tb_product (id)
