...
ADD COLUMN address_cep VARCHAR(30),
...
ADD CONSTRAINT fk_tb_restaurant_address_city FOREIGN KEY (address_city_id) REFERENCES tb_city(id);

CREATE TABLE tb_restaurant_products (
    restaurant_id BIGINT NOT NULL,
    product_id BIGINT NOT NULL,
    PRIMARY KEY (restaurant_id, product_id),
    CONSTRAINT fk_restaurant_products_restaurant FOREIGN KEY (restaurant_id) REFERENCES tb_restaurant(id),
    CONSTRAINT fk_restaurant_products_product FOREIGN KEY (product_id) REFERENCES tb_product(id)
);
